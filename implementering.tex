...
\emph{Repositories} gør datatilgangen mere kontrolleret. I stedet for at hver visning skriver direkte mod backend, samles læsning, skrivning og mapping i et lag, der kan testes og ændres. Det passer til sikkerhedsmodellen, fordi klienten stadig er en klient, mens adgangsregler og privilegerede handlinger ligger uden for visningslaget.
...
Implementeringen prioriterer kerneflowet før støttefunktionerne. Admin, import og betaling kan udvides senere, når de understøtter den basale model for brugerens træning. Test og verifikation retter sig derfor især mod build, domænelogik, sikkerhedsgrænser og kendte gaps.
