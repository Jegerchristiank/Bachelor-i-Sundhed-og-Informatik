...
Det afgørende er sammenhæng, ikke flest mulige felter. En app kan have mange tabeller uden at kunne forklare, hvad der sker, når en bruger træner anderledes end planlagt. Modellen skal bevare relationen mellem intention, handling, historik og næste skridt.
...
\tmdelkonklusion{Data- og sikkerhedsdelkonklusion}{Den bedste datamodel er ikke den mest detaljerede model, men den mest forklarlige. TræningsMester skal kunne skelne mellem plan, log og completion, samtidig med at adgang håndhæves i backend. Det giver fleksibilitet uden at gøre klienten til sikkerhedsautoritet.}
