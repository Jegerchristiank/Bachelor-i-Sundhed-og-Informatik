...
Den teoretiske og faglige ramme samler fire spor. Det første spor handler om motivation, frafald og effektivt engagement. Det andet handler om app- og tracker-evidens samt appkvalitet. Det tredje handler om progression og autoregulering i styrketræning. Det fjerde handler om interaktionsdesign, datakvalitet og sikkerhed. Tilsammen bruges sporene til at vurdere, om TræningsMester kan forbinde plan, faktisk træning, feedback og dataansvar i samme system.
...
Systematiske reviews og meta-analyser viser, at smartphoneapps og activity trackers kan øge fysisk aktivitet hos voksne, men effekterne varierer med intervention, målgruppe og brug \cite{laranjo2021_apps_trackers_meta,romeo2019_smartphone_apps_pa_meta}. Wearables kan også støtte fysisk aktivitet, især når feedback og mål er tydelige \cite{brickwood2019_wearable_trackers_meta}. Denne litteratur gør appsporet relevant for projektet, samtidig med at effekten af TræningsMester skal vurderes i senere bruger- og effektstudier.
...
Litteraturen giver to kriterier for den videre analyse. Appen skal have en tydelig adfærdsfunktion, hvor selvmonitorering, mål, feedback og handlingsstøtte hænger sammen. Interaktionen skal samtidig være praktisk nok til, at brugeren kan bruge den under træning.
...
Det faglige hul i dette projekt ligger derfor i koblingen mellem adfærdsstøtte, programlogik, lavt betjeningsbesvær og sikker dataadgang i én styrketræningsapp. Hvis sporene behandles hver for sig, bliver løsningen enten en generel motivationsapp, en teknisk logbog eller en database med brugerflade. TræningsMester undersøges som et samlet design- og implementeringsbidrag, hvor den praktiske test er, om motivation, progression, data og adgang stadig hænger sammen, når brugeren træner anderledes end planlagt.

Bidraget ligger i oversættelsen fra litteratur til app. TræningsMester skaber en konkret model for, hvordan kendte principper om motivation, feedback, progression, datakvalitet og adgangskontrol kan bygges ind i et system til realistisk træningsadfærd.
...
Autoregulering gør det relevant at justere træning efter performance, readiness og dagsform \cite{greig2020_autoregulation_resistance_training,larsen2021_autoregulation_systematic_review}. En app bør derfor skelne mellem planlagt workout, faktisk trackerlog, completion-event og næste relevante træningshandling. I de senere analysekapitler bruges bilagets tracker/completion-diagram til at vurdere denne adskillelse i TræningsMester.

ecofit-studiet viser, at mHealth kan indgå i en resistance-training-nær intervention \cite{plotnikoff2023_ecofit_rct}. I denne rapport bruges det som kontekstnær inspiration, mens TræningsMesters egen vurdering bygger på design, implementering og verifikation.
...
\tmdelkonklusion{Teoriens konsekvens}{Et stærkt designvalg skal kunne forklares fagligt, ses i appen og afgrænses metodisk. Hvis et valg kun findes i litteraturen, er det en intention. Hvis det kun findes i koden, er det en funktion. Først når begge dele mødes, bliver det et egentligt bachelorbidrag.}
