...
| `abbrvnat-etal.bst` | Lokal BibTeX-stil | `natbib`-kompatibel numerisk referencestil i første-forekomst-rækkefølge med initialer og `et al.` efter seks forfattere |
