...
- `referencer.bib`, `referencer.md`, `abbrvnat-etal.bst` og `referencer/` er referencebiblioteket med BibTeX-nøgler, kildebeskrivelser, lokal numerisk referencestil i første-forekomst-rækkefølge og lokale åbne PDF-kopier.
...
- `abbrvnat-etal.bst`: lokal `natbib`-kompatibel BibTeX-stil, der bruger initialer, forkorter lange forfatterlister med `et al.` efter seks forfattere og bevarer numerisk første-forekomst-rækkefølge.
...
- `data_sikkerhed_og_interoperabilitet.tex`: kapitelinput med færdig rapporttekst for Data, sikkerhed og interoperabilitet.
- `implementering.tex`: kapitelinput med færdig rapporttekst for Implementering.
