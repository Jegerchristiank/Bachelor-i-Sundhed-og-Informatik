...
- `main.tex` indlæser `problemformulering_og_afgraensning.tex` og `teoretisk_og_faglig_ramme.tex` som kapitelinput, `kildesoegning.tex` og `billedbilag.tex` som bilag og bruger `referencer.bib` til referenceafsnittet.
